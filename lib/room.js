(function() {
  ...
  Room.prototype.start = function () {
    ...
    this.timers.push(new ZedTV.Util.PausableInterval(
      this.spawnMobs.bind(this, ZedTV.Grunt, Room.GRUNTS_PER_SPAWN, ZedTV.Grunt.PLAYER_BUFFER),
      Room.GRUNT_SPAWN_FREQ
    ));

    this.timers.push(new ZedTV.Util.PausableInterval(
      this.spawnMobs.bind(this, ZedTV.Shooter, Room.SHOOTERS_PER_SPAWN, ZedTV.Shooter.PLAYER_BUFFER),
  ...
  Room.prototype.spawnMobs = function (Mob, num, buff) {
    for (var i = 0; i < num; i++) {
